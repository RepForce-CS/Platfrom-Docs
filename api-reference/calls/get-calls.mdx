...
```json 200 Response
{
  ...
  "first_page_url": "https://app.repforce.ai/api/user/calls?page=1",
  "from": 1,
  "last_page": 10,
  "last_page_url": "https://app.repforce.ai/api/user/calls?page=10",
  "links": [
    {
      "url": null,
    ...
    {
      "url": "https://app.repforce.ai/api/user/calls?page=1",
      "label": "1",
      "active": true
    },
    {
      "url": "https://app.repforce.ai/api/user/calls?page=2",
      "label": "2",
      "active": false
    }
  ],
  "next_page_url": "https://app.repforce.ai/api/user/calls?page=2",
  "path": "https://app.repforce.ai/api/user/calls",
  "per_page": 15,
  "prev_page_url": null,
  "to": 15,
  "total": 150
