...
```bash cURL
curl -X POST "https://app.repforce.ai/api/user/ai/generate-reply" \
...
const response = await fetch('https://app.repforce.ai/api/user/ai/generate-reply', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://app.repforce.ai/api/user/ai/generate-reply',
    headers={
        'Authorization': 'Bearer YOUR_API_TOKEN',
        'Content-Type': 'application/json'
    },
...
$response = Http::withToken('YOUR_API_TOKEN')
    ->post('https://app.repforce.ai/api/user/ai/generate-reply', [
        'assistant_id' => 123,
        'customer_identifier' => '+14155551234',
        'message' => 'Hi, I would like to schedule an appointment',
        'variables' => [
